...
func main() {
	themes := []Theme{
		...
		{
			Name:   "material-light",
			URL:    "https://raw.githubusercontent.com/Dramaga11/vsc-material-theme/refs/heads/main/assets/vsc-community-material-theme-1.4.5.vsix",
			Target: "material",
			File:   "extension/themes/Community-Material-Theme-Lighter.json",
			Dark:   false,
			Invert: false,
			Zip:    true,
		},
		{
			...
			URL:    "https://raw.githubusercontent.com/Dramaga11/vsc-material-theme/refs/heads/main/assets/vsc-community-material-theme-1.4.5.vsix",
			Target: "material",
			File:   "extension/themes/Community-Material-Theme-Default.json",
			Dark:   true,
			Invert: false,
			Zip:    true,
		},
		{
			Name:   "github-light",
			URL:    "https://marketplace.visualstudio.com/_apis/public/gallery/publishers/GitHub/vsextensions/github-vscode-theme/6.3.3/vspackage",
			Target: "github",
